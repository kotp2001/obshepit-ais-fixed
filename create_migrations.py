...
print("2. Создаём суперпользователя...")
...
if Dish.objects.count() == 0:
    dishes = [
        ...
        {'name': 'Чай чёрный', 'price': 80, 'category_id': 4, 'description': 'Цейлонский чай, сахар по желанию'},
        {'name': 'Чай зелёный', 'price': 80, 'category_id': 4, 'description': 'Зелёный чай, сахар по желанию'},
